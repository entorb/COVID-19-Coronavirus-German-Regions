...
function fetch_table_data() {
  table.setData(
    "https://entorb.net/COVID-19-coronavirus/data/de-districts/de-districts-results-V2.json",
    {},
    "get"
  );
}
...
function write_to_backend(param) {
  ...
  console.log(param);
  $.get(
    "https://entorb.net/COVID-19-coronavirus/newsletter-backend.py",
    param,
    function (response) {
      console.log("Response:");
      console.log(response);
...
function defineTable() {
  const table = new Tabulator("#div_table-de-districts", {
    ...
    columns: [
      ...
      // },
      {
        title: "Infizierte<br/>letzte Woche<br/>pro 100t EW.",
        field: "Cases_Last_Week_Per_100000",
        width: 135,
        sorter: "number",
        hozAlign: "right",
        sorterParams: {
      ...
      {
        title: "Infizierte<br/>letzte Woche<br/>gesamt",
        field: "Cases_Last_Week",
        sorter: "number",
        width: 135,
        hozAlign: "right",
        sorterParams: {
    ...
    rowClick: function (e, row) {
      ...
      const clickedCode = rowData["LK_ID"];
      const clickedDistrict = rowData["Landkreis"];
