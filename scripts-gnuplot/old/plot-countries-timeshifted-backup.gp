...
title = "Weekly deaths per million after 2nd death"
set title title
set ylabel "Weekls deaths per million"


set label 11 "AT" left at first last_x_AT/7.0 , first last_y_last_week_pm_AT
set label 12 "BE" left at first last_x_BE/7.0 , first last_y_last_week_pm_BE
set label 13 "CA" left at first last_x_CA/7.0 , first last_y_last_week_pm_CA
set label 14 "FR" left at first last_x_FR/7.0 , first last_y_last_week_pm_FR
set label 15 "DE" left at first last_x_DE/7.0 , first last_y_last_week_pm_DE
set label 16 "HU" left at first last_x_HU/7.0 , first last_y_last_week_pm_HU
set label 17 "IR" left at first last_x_IR/7.0 , first last_y_last_week_pm_IR
set label 18 "IT" left at first last_x_IT/7.0 , first last_y_last_week_pm_IT
set label 19 "JP" left at first last_x_JP/7.0 , first last_y_last_week_pm_JP
set label 20 "KR" left at first last_x_KR/7.0 , first last_y_last_week_pm_KR
set label 21 "NL" left at first last_x_NL/7.0 , first last_y_last_week_pm_NL
set label 22 "PT" left at first last_x_PT/7.0 , first last_y_last_week_pm_PT
set label 23 "ES" left at first last_x_ES/7.0 , first last_y_last_week_pm_ES
set label 24 "CH" left at first last_x_CH/7.0 , first last_y_last_week_pm_CH
set label 25 "UK" left at first last_x_UK/7.0 , first last_y_last_week_pm_UK
set label 26 "US" left at first last_x_US/7.0 , first last_y_last_week_pm_US
set label 27 "SE" left at first last_x_SE/7.0 , first last_y_last_week_pm_SE
...
output = '../plots-gnuplot/int/countries-timeshifted-last_week-per-million.png'
set output output
plot \
  '../data/int/country-IT.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Italy" with lines lw 2, \
  '../data/int/country-IR.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Iran" with lines lw 2, \
  '../data/int/country-DE.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Germany" with lines lw 2, \
  '../data/int/country-FR.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "France" with lines lw 2, \
  '../data/int/country-ES.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Spain" with lines lw 2, \
  '../data/int/country-AT.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Austria" with lines lw 2, \
  '../data/int/country-GB.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "United Kingdom" with lines lw 2, \
  '../data/int/country-US.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "US" with lines lw 2, \
  '../data/int/country-BE.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Belgium" with lines lw 2 dt "-", \
  '../data/int/country-CA.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Canada" with lines lw 2 dt "-", \
  '../data/int/country-HU.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Hungary" with lines lw 2 dt "-", \
  '../data/int/country-NL.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Netherlands" with lines lw 2 dt "-", \
  '../data/int/country-PT.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Portugal" with lines lw 2 dt "-", \
  '../data/int/country-CH.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Switzerland" with lines lw 2 dt "-", \
  '../data/int/country-JP.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Japan" with lines lw 2 dt "-", \
  '../data/int/country-KR.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Korea, South" with lines lw 2 dt "-",\
  '../data/int/country-SE.tsv' using (column("Days_Since_2nd_Death")/7):(column("Deaths_Last_Week_Per_Million")) title "Sweden" with lines lw 2 dt ".",\
...
set logscale y ; set logscale y2
set title title ." - log. scaled"
output= '../plots-gnuplot/int/countries-timeshifted-last_week-per-million-log.png'
set output output
replot
unset output
## replot to set y2range accordingly to yrange
